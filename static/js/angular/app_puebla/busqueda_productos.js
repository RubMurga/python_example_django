...
busqueda_libro.controller('LibreriaCtrl', function($scope, $http){
    ...
    $scope.buscarProducto = function(){
        var url = "/Puebla/libreria/agregar-producto/busqueda-articulo/?nombre_art="+$scope.libreria_input;
        $http.get(url).success(function(data){
            toastr.warning("Ya existe un libro con ese nombre, mejor agrega articulos al libro en el formulario de abajo :D");
        }).error(function (data) {
...
busqueda_categoria.controller('CategoriaCtrl', function($scope, $http){
    $scope.buscarCategoria = function(){
        var url = "/Puebla/libreria/buscar/categoria-angular/?nombre_cat="+$scope.categoria_input;
        $http.get(url).success(function(data){
...
busqueda_cafeteria.controller('CafeteriaCtrl', function ($scope, $http) {
    $scope.buscar_producto = function() {
        var url = "/Puebla/cafeteria/buscar/articulo/?nombre_art="+$scope.cafeteria_input;
        $http.get(url).success(function (data) {
