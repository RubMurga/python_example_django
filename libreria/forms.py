...
class ProductoForm(forms.ModelForm):
    ...
    nombre_libro = forms.ModelChoiceField(queryset = Articulo.objects.all(), widget = forms.Select(attrs={'class':'form-control'}), label = 'Nombre del libro' )
...
class Cambiar_precio_form(forms.Form):
    producto = forms.ModelChoiceField(queryset = Articulo.objects.filter(sucursal=0),widget = forms.Select(attrs={'class':'form-control'}), label = 'Nombre del libro' )
...
class borrar_libro_form(forms.Form):
    producto = forms.ModelChoiceField(queryset = Articulo.objects.filter(sucursal=0),widget = forms.Select(attrs={'class':'form-control'}), label = 'Nombre del libro a borrar' )
