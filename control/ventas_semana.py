...
def ventas_semana():
    ...
    if hoy.weekday() == 0:
        ...
        ventas_lunes_libreria, ventas_lunes_cafeteria,ventas_lunes_comercializadora = ventas_lunes(hoy.day,hoy.month,hoy.year, 1,0,0,0)
        ...
        ventas_lunes_libreria, ventas_lunes_cafeteria ,ventas_lunes_comercializadora= ventas_lunes(hoy.day,hoy.month,hoy.year, 2,0,0,0)
        ventas_martes_libreria, ventas_martes_cafeteria,ventas_martes_comercializadora = ventas_martes(hoy.day,hoy.month,hoy.year, 1,0,0,0)
        ...
        ventas_lunes_libreria, ventas_lunes_cafeteria,ventas_lunes_comercializadora = ventas_lunes(hoy.day,hoy.month,hoy.year, 3,0,0,0)
        ventas_martes_libreria, ventas_martes_cafeteria,ventas_martes_comercializadora = ventas_martes(hoy.day,hoy.month,hoy.year, 2,0,0,0)
        ventas_miercoles_libreria, ventas_miercoles_cafeteria,ventas_miercoles_comercializadora = ventas_miercoles(hoy.day,hoy.month,hoy.year, 1,0,0,0)
        ...
        ventas_lunes_libreria, ventas_lunes_cafeteria,ventas_lunes_comercializadora = ventas_lunes(hoy.day,hoy.month,hoy.year, 4,0,0,0)
        ventas_martes_libreria, ventas_martes_cafeteria,ventas_martes_comercializadora = ventas_martes(hoy.day,hoy.month,hoy.year, 3,0,0,0)
        ventas_miercoles_libreria, ventas_miercoles_cafeteria,ventas_miercoles_comercializadora = ventas_miercoles(hoy.day,hoy.month,hoy.year, 2,0,0,0)
        ventas_jueves_libreria, ventas_jueves_cafeteria,ventas_jueves_comercializadora = ventas_jueves(hoy.day,hoy.month,hoy.year, 1,0,0,0)
        ...
        ventas_lunes_libreria, ventas_lunes_cafeteria,ventas_lunes_comercializadora = ventas_lunes(hoy.day,hoy.month,hoy.year, 5,0,0,0)
        ventas_martes_libreria, ventas_martes_cafeteria,ventas_martes_comercializadora = ventas_martes(hoy.day,hoy.month,hoy.year, 4,0,0,0)
        ventas_miercoles_libreria, ventas_miercoles_cafeteria,ventas_miercoles_comercializadora = ventas_miercoles(hoy.day,hoy.month,hoy.year, 3,0,0,0)
        ventas_jueves_libreria, ventas_jueves_cafeteria,ventas_jueves_comercializadora = ventas_jueves(hoy.day,hoy.month,hoy.year, 2,0,0,0)
        ventas_viernes_libreria, ventas_viernes_cafeteria,ventas_viernes_comercializadora = ventas_viernes(hoy.day,hoy.month,hoy.year,1,0,0,0)
        ...
        ventas_lunes_libreria, ventas_lunes_cafeteria,ventas_lunes_comercializadora = ventas_lunes(hoy.day,hoy.month,hoy.year,6,0,0,0)
        ventas_martes_libreria, ventas_martes_cafeteria,ventas_martes_comercializadora = ventas_martes(hoy.day,hoy.month,hoy.year, 5,0,0,0)
        ventas_miercoles_libreria, ventas_miercoles_cafeteria,ventas_miercoles_comercializadora = ventas_miercoles(hoy.day,hoy.month,hoy.year, 4,0,0,0)
        ventas_jueves_libreria, ventas_jueves_cafeteria,ventas_jueves_comercializadora = ventas_jueves(hoy.day,hoy.month,hoy.year, 3,0,0,0)
        ventas_viernes_libreria, ventas_viernes_cafeteria,ventas_viernes_comercializadora = ventas_viernes(hoy.day,hoy.month,hoy.year,2,0,0,0)
        ventas_sabado_libreria, ventas_sabado_cafeteria,ventas_sabado_comercializadora = ventas_sabado(hoy.day,hoy.month,hoy.year,1,0,0,0)
...
def ventas_domingo(hoy,mes,anio,resta,usuario,validador,producto):
    if validador == 0:
        ...
        return ventas_1, ventas_2, ventas_domingo_comercializadora
    elif validador == 1:
...
def ventas_semana_ven(usuario):
    ...
    if hoy.weekday() == 0:
        ...
        ventas_lunes_libreria, ventas_lunes_cafeteria,ventas_lunes_comercializadora = ventas_lunes(hoy.day,hoy.month,hoy.year, 1,usuario,0,0)
        ...
        ventas_lunes_libreria, ventas_lunes_cafeteria,ventas_lunes_comercializadora = ventas_lunes(hoy.day,hoy.month,hoy.year, 2,usuario,0,0)
        ventas_martes_libreria, ventas_martes_cafeteria,ventas_martes_comercializadora = ventas_martes(hoy.day,hoy.month,hoy.year, 1,usuario,0,0)
        ...
        ventas_lunes_libreria, ventas_lunes_cafeteria,ventas_lunes_comercializadora = ventas_lunes(hoy.day,hoy.month,hoy.year, 3,usuario,0,0)
        ventas_martes_libreria, ventas_martes_cafeteria,ventas_martes_comercializadora = ventas_martes(hoy.day,hoy.month,hoy.year, 2,usuario,0,0)
        ventas_miercoles_libreria, ventas_miercoles_cafeteria,ventas_miercoles_comercializadora = ventas_miercoles(hoy.day,hoy.month,hoy.year, 1,usuario,0,0)
        ...
        ventas_lunes_libreria, ventas_lunes_cafeteria,ventas_lunes_comercializadora = ventas_lunes(hoy.day,hoy.month,hoy.year, 4,usuario,0,0)
        ventas_martes_libreria, ventas_martes_cafeteria,ventas_martes_comercializadora = ventas_martes(hoy.day,hoy.month,hoy.year, 3,usuario,0,0)
        ventas_miercoles_libreria, ventas_miercoles_cafeteria,ventas_miercoles_comercializadora = ventas_miercoles(hoy.day,hoy.month,hoy.year, 2,usuario,0,0)
        ventas_jueves_libreria, ventas_jueves_cafeteria,ventas_jueves_comercializadora = ventas_jueves(hoy.day,hoy.month,hoy.year, 1,usuario,0,0)
        ...
        ventas_lunes_libreria, ventas_lunes_cafeteria,ventas_lunes_comercializadora = ventas_lunes(hoy.day,hoy.month,hoy.year, 5,usuario,0,0)
        ventas_martes_libreria, ventas_martes_cafeteria,ventas_martes_comercializadora = ventas_martes(hoy.day,hoy.month,hoy.year, 4,usuario,0,0)
        ventas_miercoles_libreria, ventas_miercoles_cafeteria,ventas_miercoles_comercializadora = ventas_miercoles(hoy.day,hoy.year,hoy.month, 3,usuario,0,0)
        ventas_jueves_libreria, ventas_jueves_cafeteria,ventas_jueves_comercializadora = ventas_jueves(hoy.day,hoy.month,hoy.year, 2,usuario,0,0)
        ventas_viernes_libreria, ventas_viernes_cafeteria,ventas_viernes_comercializadora = ventas_viernes(hoy.day,hoy.month,hoy.year,1,usuario,0,0)
        ...
        ventas_lunes_libreria, ventas_lunes_cafeteria,ventas_lunes_comercializadora = ventas_lunes(hoy.day,hoy.month,hoy.year, 6,usuario,0,0)
        ventas_martes_libreria, ventas_martes_cafeteria,ventas_martes_comercializadora = ventas_martes(hoy.day,hoy.month,hoy.year, 5,usuario,0,0)
        ventas_miercoles_libreria, ventas_miercoles_cafeteria,ventas_miercoles_comercializadora = ventas_miercoles(hoy.day,hoy.month,hoy.year, 4,usuario,0,0)
        ventas_jueves_libreria, ventas_jueves_cafeteria,ventas_jueves_comercializadora = ventas_jueves(hoy.day,hoy.month,hoy.year, 3,usuario,0,0)
        ventas_viernes_libreria, ventas_viernes_cafeteria,ventas_viernes_comercializadora = ventas_viernes(hoy.day,hoy.month,hoy.year,2,usuario,0,0)
        ventas_sabado_libreria, ventas_sabado_cafeteria,ventas_sabado_comercializadora = ventas_sabado(hoy.day,hoy.month,hoy.year,1,usuario,0,0)
...
def ventas_semana_libreria_inicial(usuario,producto):
    ...
    if hoy.weekday() == 0:
        ...
        for libro in ventas_lunes_libreria:
            pro = Articulo_libreria.objects.all().filter(id = int(libro['nombre_libro']),sucursal=0)
...
def ventas_semana_cafeteria_inicial(usuario,producto):
    ...
    if hoy.weekday() == 0:
        ...
        for libro in ventas_lunes_cafeteria:
            pro = Articulo_cafeteria.objects.all().filter(id = int(libro['nombre_producto']),sucursal=0)
